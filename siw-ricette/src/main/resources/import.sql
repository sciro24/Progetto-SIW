...
insert into utente(id, cognome, email, nome) values (nextval('utente_seq'), 'Andreoni', 'andriu@hotmail.com', 'Andrea');
insert into utente(id, cognome, email, nome) values (nextval('utente_seq'), 'Scirocco', 'lorenzo.scirocco@gmail.com', 'Lorenzo');
insert into utente(id, cognome, email, nome) values (nextval('utente_seq'), 'Bianchi', 'bianchi@gmail.com', 'Fede');
insert into utente(id, cognome, email, nome) values (nextval('utente_seq'), 'Neri', 'neri@gmail.com', 'Fra');
...
insert into credenziali(id, password, role, username, utente_id) values (nextval('credenziali_seq'), '$2a$10$S6HueP.58CzXZhQtat/sGOHgpoRSDpYQ835AA3Gq1Pu2dOijVLzCS', 'DEFAULT', 'Andrea', (select id from utente where email = 'andriu@hotmail.com')); 
insert into credenziali(id, password, role, username, utente_id) values (nextval('credenziali_seq'), '$2a$10$KTHFybov.hr94njClsS7qu/V21ngPGM9nCJlBbi6cOAOP7urmTQMe', 'ADMIN', 'Lorenzo', (select id from utente where email = 'lorenzo.scirocco@gmail.com'));
...
insert into ricetta(id, descrizione, nome, tempo_preparazione, url_of_picture) values (nextval('ricetta_seq'), 'Soffriggi cipolla in burro, aggiungi riso e tosta per alcuni minuti. Versa brodo caldo poco alla volta fino a cottura completa. Aggiungi funghi trifolati e parmigiano. Mescola e servi caldo.', 'Risotto ai Funghi', 45, 'https://www.cucchiaio.it/content/dam/cucchiaio/it/ricette/2013/12/ricetta-risotto-funghi-porcini-zafferano/risotto-porcini-zafferano-finale.jpg');
insert into ricetta(id, descrizione, nome, tempo_preparazione, url_of_picture) values (nextval('ricetta_seq'), 'Prepara una base con pomodoro e mozzarella su pasta per pizza. Cuoci in forno fino a doratura. Aggiungi basilico fresco prima di servire.', 'Pizza Margherita', 60, 'https://it.ooni.com/cdn/shop/articles/Margherita-9920.jpg?crop=center&height=800&v=1644590028&width=800');
insert into ricetta(id, descrizione, nome, tempo_preparazione, url_of_picture) values (nextval('ricetta_seq'), 'Cuoci pasta in acqua salata. In una padella, rosola pancetta, aggiungi uova sbattute e pecorino. Mescola con pasta cotta, crea una crema senza cuocere troppo.', 'Pasta alla Carbonara', 25, 'https://www.giallozafferano.it/images/219-21928/Spaghetti-alla-Carbonara_650x433_wm.jpg');
insert into ricetta(id, descrizione, nome, tempo_preparazione, url_of_picture) values (nextval('ricetta_seq'), 'Rosola guanciale in padella. Aggiungi pomodoro e cuoci fino a ridurre. Mescola con pasta cotta e pecorino. Servi con pepe nero a piacere.', 'Pasta Amatriciana', 35, 'https://www.buttalapasta.it/wp-content/uploads/2011/09/pasta-all-amatriciana-con-pancetta.jpg');
insert into ricetta(id, descrizione, nome, tempo_preparazione, url_of_picture) values (nextval('ricetta_seq'), 'Cuoci pasta e scolala. In una padella, sciogli pecorino con un po’ di acqua di cottura. Aggiungi pepe macinato e mescola con pasta.', 'Cacio e Pepe', 20, 'https://www.casapappagallo.it/storage/17060/cacio-e-pepe.jpg');
...
insert into recensione(id, commento, voto, ricetta_id, utente_id) values (nextval('recensione_seq'), 'Deliziosa! Facile da fare e molto gustosa.', 5, 1, 5);
...
insert into recensione(id, commento, voto, ricetta_id, utente_id) values (nextval('recensione_seq'), 'La pizza era buona, ma poteva essere più croccante.', 3, 3, 5);
...
insert into recensione(id, commento, voto, ricetta_id, utente_id) values (nextval('recensione_seq'), 'Cacio e Pepe molto buono, semplice e gustoso.', 4, 6, 5);
...
insert into recensione(id, commento, voto, ricetta_id, utente_id) values (nextval('recensione_seq'), 'Carbonara con troppa pancetta, ma comunque buona.', 3, 4, 6);
insert into recensione(id, commento, voto, ricetta_id, utente_id) values (nextval('recensione_seq'), 'Amatriciana favolosa, la migliore che abbia mai mangiato.', 5, 5, 6);
...
insert into recensione(id, commento, voto, ricetta_id, utente_id) values (nextval('recensione_seq'), 'Il risotto ai funghi aveva un sapore fantastico.', 5, 2, 6);
